...
function MoviesInaformetion() {
  ...
  const addToWatchlist = async () => {
    ...
    await axios.post(
      `${baseUrl}/account/${
        user.id
      }/watchlist?api_key=1056e7134c2cd97a56cc1f66078fd147&session_id=${localStorage.getItem(
        "session_id"
      )}`,
      {
        media_type: "movie",
      ...
      <Grid item container direction="column" lg={7}>
        ...
        <Grid item className={classes.genresContainer}>
          {data?.genres?.map((genre) => (
            ...
            >
              <img
                src={genreCategoryIcons[genre?.name.toLowerCase()]}
...
export default MoviesInaformetion;
